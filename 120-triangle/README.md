<h2><a href="https://leetcode.com/problems/triangle/">120. Triangle</a></h2><h3>Medium</h3><hr><div><p>Given a <code style="">triangle</code> array, return <em>the minimum path sum from top to bottom</em>.</p>
